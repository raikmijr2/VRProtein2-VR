...
public class ManipulationManager : MonoBehaviour {
    ...
    void Update ()
    {
        ...
        try {
            if (curUIInput == null && Input.GetButton("RotationXLeft")) { RotateAroundCentroid(speedX, 0); }
            if (curUIInput == null && Input.GetButton("RotationXRight")) { RotateAroundCentroid(-speedX, 0); }
            if (curUIInput == null && Input.GetButton("RotationYLeft")) { RotateAroundCentroid(speedY, 1); }
            if (curUIInput == null && Input.GetButton("RotationYRight")) { RotateAroundCentroid(-speedY, 1); }
            if (curUIInput == null && Input.GetButton("RotationZLeft")) { RotateAroundCentroid(speedZ, 2); }
            if (curUIInput == null && Input.GetButton("RotationZRight")) { RotateAroundCentroid(-speedZ, 2); }
        } catch { }
        ...
        try {
            if (curUIInput == null && Input.GetButton("ZoomIn")) { stopCurrentMovements(); ZoomInOut(moveSpeed * 0.1f); }
            if (curUIInput == null && Input.GetButton("ZoomOut")) { stopCurrentMovements(); ZoomInOut(-moveSpeed * 0.1f); }
        } catch { }
        ...
        if (translatingT != null) {
            if (Input.GetMouseButtonUp(0) || SafeGetButton("TranslateClicked")) {
                translatingT = null;
            }
            else {
                stopCurrentMovements();
        ...
        else if (curUIInput == null && SafeGetButton("TranslateClicked") &&
        ...
        if (rotatingT != null) {
            if (Input.GetMouseButtonUp(0) || SafeGetButton("RotateClicked")) {
                rotatingT = null;
            }
            else {
                stopCurrentMovements();
        ...
        //Clicked with rotate
        else if (curUIInput == null && SafeGetButton("RotateClicked") &&
                 Input.GetMouseButtonDown(0) && !UnityEngine.EventSystems.EventSystem.current.IsPointerOverGameObject()) {
            UnityMolAtom a = getAtomPointed();
            if (a != null) {
