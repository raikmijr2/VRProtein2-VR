...
public class SwitchSelectionMode : MonoBehaviour {
    ...
    void UpdateButtonText() {
        string modeStr = selM.selectionMode switch {
            UnityMolSelectionManager.SelectionMode.Atom    => "\nAtom</b></color>",
            UnityMolSelectionManager.SelectionMode.Residue => "\nResidue</b></color>",
            UnityMolSelectionManager.SelectionMode.Chain   => "\nChain</b></color>",
            _                                              => "\nResidue</b></color>"
        };
        butText.text = firstPartText + modeStr;
    }
