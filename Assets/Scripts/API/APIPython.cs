...
public class APIPython : MonoBehaviour {
    ...
    public static void setAmbientLightIntensity(float ambientLightValue) {
        ...
        Color baseAmbient = UnityMolMain.initAmbientColor;
        if (baseAmbient.maxColorComponent < 0.01f) baseAmbient = Color.white;
        RenderSettings.ambientLight = baseAmbient * ambientLightValue;
