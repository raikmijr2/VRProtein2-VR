...
public class UIManager : MonoBehaviour {
	...
	public void switchOutline(Text t) {
		...
		if (Camera.main == null) { Debug.LogWarning("No main camera found"); return; }
	...
	public void disconnectIMD() {
		if (APIPython.last() == null) { Debug.LogWarning("No molecule loaded"); return; }
	...
	void LateUpdate() {
		...
		try {
			if (curUIInput == null && Input.GetButton("Hyperballs")) { showHB(); }
			if (curUIInput == null && Input.GetButton("Cartoon")) { showCartoon(); }
			if (curUIInput == null && Input.GetButton("Surface")) { showSurface(); }
			if (curUIInput == null && Input.GetButton("VdW")) { showVDW(); }
			if (curUIInput == null && Input.GetButton("Screenshot")) { saveScreenshot(); }
		} catch { }
