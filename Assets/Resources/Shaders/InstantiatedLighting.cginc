...
// AutoLight.cginc is incompatible with URP — stub out the macros we use
#define UNITY_SHADOW_COORDS(idx)
#define UNITY_TRANSFER_SHADOW(a, b)
#define UNITY_LIGHT_ATTENUATION(dest, input, worldPos) float dest = 1.0f;
#define SHADOW_ATTENUATION(a) 1.0f
#define HANDLE_SHADOWS_BLENDING_IN_GI 0
