...
namespace UMol
{
    public class MDAnalysisSelection
    {
        ...
        public Dictionary<string, MDASelection> selectionKeywords =
            new Dictionary<string, MDASelection>();
        ...
        public MDAnalysisSelection(string selStr, List<UnityMolAtom> atoms)
        {
            ...
            selectionKeywords["resnum"] = new RangeResnumSelection(this, "resnum", 0);
            ...
            selectionKeywords["nucleicbackbone"] = new NucleicBackboneSelection(
                this,
                "nucleicbackbone",
                0
            );
            ...
            selectionKeywords["inrect"] = new InRectangleSelection(this, "inrect", 0);
            ...
            {
                selectionKeywords[keyw] = new SelectionSelection(
                    this,
                    selM.selectionMDAKeywords[keyw],
                    0
                );
            }
        ...
        {
            return ProteinSelection.knownResidues.Contains(a.residue.name) && !a.isHET;
        }
        ...
        {
            return NucleicSelection.knownNucleic.Contains(a.residue.name) && !a.isHET;
        }
        ...
        public static bool isBondedToBackbone(UnityMolAtom a, UnityMolBonds bonds)
        {
            ...
            if (bonds.bonds.TryGetValue(a.idInAllAtoms, out bonded))
            {
                for (int i = 0; i < bonded.Length; i++)
                {
                    if (bonded[i] != -1)
                    {
                        UnityMolAtom at = a.residue.chain.model.allAtoms[bonded[i]];
                        if (BackboneSelection.knownBases.Contains(at.name))
                        {
                            isBondedToBB = true;
                            break;
                        }
                        if (NucleicBackboneSelection.knownNucleicBBBases.Contains(at.name))
                        {
                            isBondedToBB = true;
                            break;
                        }
    ...
    public class SelectionParser
    {
        ...
        public MetaClass parseExpression(int p)
        {
            ...
            while (
                curToken < tokens.Count
                && mdaSel.isOperator(tokens[curToken])
                && mdaSel.operatorKeywords[tokens[curToken]].precedence >= p
            )
            {
    ...
    public abstract class MetaClass
    {
        ...
        public MetaClass(MetaClass cpy)
            : this()
        {
    ...
    public abstract class Operation : MetaClass
    {
        ...
        public Operation(Operation cpy)
            : base(cpy) { }
    }

    public class AndOperation : Operation
    {
        public AndOperation(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public AndOperation(AndOperation cpy)
            : base(cpy)
        {
        ...
        public override MetaClass Clone()
        {
            return new AndOperation(this);
        }
    }

    public class OrOperation : Operation
    {
        public OrOperation(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public OrOperation(OrOperation cpy)
            : base(cpy)
        {
            this.leftSel = cpy.leftSel.Clone();
            this.rightSel = cpy.rightSel.Clone();
    ...
    public abstract class MDASelection : MetaClass
    {
        ...
        public MDASelection(MDASelection cpy)
            : base(cpy) { }
    }

    public class AllSelection : MDASelection
    {
        public AllSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public AllSelection(AllSelection cpy)
            : base(cpy) { }
        ...
        public override MetaClass Clone()
        {
            return new AllSelection(this);
        }
    }

    public class NothingSelection : MDASelection
    {
        public NothingSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public NothingSelection(NothingSelection cpy)
            : base(cpy) { }
        ...
        public override MetaClass Clone()
        {
            return new NothingSelection(this);
        }
    }
    ...
    public class UnarySelection : MDASelection
    {
        ...
        public UnarySelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }
        ...
        public UnarySelection(UnarySelection cpy)
            : base(cpy)
        {
        ...
        public override MetaClass Clone()
        {
            return new UnarySelection(this);
        }
    }

    public class NotSelection : UnarySelection
    {
        public NotSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public NotSelection(NotSelection cpy)
            : base(cpy) { }
    ...
    {
        public ByResSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public ByResSelection(ByResSelection cpy)
            : base(cpy) { }
        ...
        public override MetaClass Clone()
        {
            return new ByResSelection(this);
        }
    }
    ...
    public class RangeResidSelection : MDASelection
    {
        ...
        public RangeResidSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p)
        {
            uppers = new List<int>();
            lowers = new List<int>();
        ...
        public override void init(List<string> tokens, ref int curId)
        {
            ...
            if (values.Count == 0)
            {
                throw new System.Exception(
                    "Unexpected token in selection : '" + tokens[curId] + "'"
                );
            }
            ...
            foreach (string val in values)
            {
                ...
                catch (System.Exception e)
                {
                    if (val.Contains(":"))
                    {
                        ...
                        {
                            throw new System.Exception(
                                "Unexpected token in selection : '" + val + "'\n" + e
                            );
                        }
                    }
                    else
        ...
        public RangeResidSelection(RangeResidSelection cpy)
            : base(cpy)
        {
        ...
        public override MetaClass Clone()
        {
            return new RangeResidSelection(this);
        }
    }

    public class RangeResnumSelection : MDASelection
    {
        public int valueOffset = 0;
        public List<int> uppers;
        public List<int> lowers;

        public RangeResnumSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p)
        {
            uppers = new List<int>();
            lowers = new List<int>();
        ...
        public override HashSet<UnityMolAtom> apply(HashSet<UnityMolAtom> group)
        {
            ...
            foreach (UnityMolAtom a in group)
            {
                for (int i = 0; i < lowers.Count; i++)
                {
                    if (uppers[i] == int.MaxValue)
                    {
                        if (a.residue.resnum == lowers[i])
                        {
                            result.Add(a);
                        }
                        continue;
                    }
                    if (a.residue.resnum >= lowers[i] && a.residue.resnum <= uppers[i])
                    {
                        result.Add(a);
                    }
                }
        ...
        public RangeResnumSelection(RangeResnumSelection cpy)
            : base(cpy)
        {
            this.valueOffset = cpy.valueOffset;
            this.uppers = cpy.uppers;
        ...
        public override MetaClass Clone()
        {
            return new RangeResnumSelection(this);
        }
    }
    ...
    public class RangeAtomIdSelection : MDASelection
    {
        ...
        public RangeAtomIdSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p)
        {
            uppers = new List<int>();
            lowers = new List<int>();
        ...
        public RangeAtomIdSelection(RangeAtomIdSelection cpy)
            : base(cpy)
        {
            this.valueOffset = cpy.valueOffset;
            this.uppers = cpy.uppers;
        ...
        public override MetaClass Clone()
        {
            return new RangeAtomIdSelection(this);
        }
    }
    ...
    public class StringSelection : MDASelection
    {
        ...
        public StringSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }
                ...
                if (wildCardPos == -1)
                {
                    switch (field)
                    {
                        ...
                        case "structnames":
                            foreach (UnityMolAtom a in group)
                            {
                                if (a.residue.chain.model.structure.name == val)
                                {
                                    result.Add(a);
                                }
                            }
                            ...
                            break;
                        case "selectionname":
                            UnityMolSelection sel = UnityMolMain.getSelectionManager().selections[
                                val
                            ];
                ...
                { //Wildcard
                    ...
                    switch (field)
                    {
                        ...
                        case "structnames":
                            foreach (UnityMolAtom a in group)
                            {
                                if (a.residue.chain.model.structure.name.StartsWith(val))
                                {
                                    result.Add(a);
                                }
                            }
        ...
        public StringSelection(StringSelection cpy)
            : base(cpy)
        {
            this.vals = cpy.vals;
    ...
    {
        public AtomNameSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p)
        {
            field = "names";
        }
    ...
    {
        public StructureNameSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p)
        {
            suite = false;
            field = "structnames";
    ...
    {
        public AtomTypeNameSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p)
        {
            field = "types";
        }
    ...
    {
        public ResidueNameSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p)
        {
            field = "resnames";
        }
    ...
    {
        public ChainNameSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p)
        {
            field = "chainnames";
        }
    ...
    {
        public ModelNameSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p)
        {
            field = "modelname";
        }
    ...
    {
        public SelectionSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p)
        {
            suite = false;
            field = "selectionname";
    ...
    public class SecondaryStructureSelection : MDASelection
    {
        ...
        public SecondaryStructureSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public SecondaryStructureSelection(SecondaryStructureSelection cpy)
            : base(cpy)
        {
        ...
        public override MetaClass Clone()
        {
            return new SecondaryStructureSelection(this);
        }
    }
    ...
    public class DistanceSelection : MDASelection
    {
        ...
        public DistanceSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }
        ...
        public DistanceSelection(DistanceSelection cpy)
            : base(cpy)
        {
        ...
        public override MetaClass Clone()
        {
            return new DistanceSelection(this);
        }
    }
    ...
    public class AroundSelection : DistanceSelection
    {
        ...
        public AroundSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }
        ...
        public override HashSet<UnityMolAtom> apply(HashSet<UnityMolAtom> group)
        {
            ...
            int maxRes = (int)((Mathf.PI * 1.333f * cutoff * cutoff * cutoff) * 0.35f); //Assuming 0.35 atom per Angstrom^3
            ...
            {
                if (s == null)
                    s = a.residue.chain.model.structure;
                if (s != a.residue.chain.model.structure)
                {
                    sameS = false;
                    break;
                }
            ...
            if (sameS)
            { //Atoms are from the same structure -> we can use the structure spatial search
                NativeArray<int> results = s.spatialSearch.SearchWithin(tmpSel, cutoff, maxRes);

                for (int i = 0; i < results.Length; i++)
                {
                    if (results[i] != -1 && results[i] < s.Count)
                    {
                        UnityMolAtom resA = s.currentModel.allAtoms[results[i]];
                        if (group.Contains(resA))
                        {
                            result.Add(resA);
                        }
                    }
            ...
            // #if True
            //Fast grid based neighbor search
            float start = Time.realtimeSinceStartup;

            Vector3[] allPointsg = new Vector3[group.Count];
            Vector3[] queries = new Vector3[tmpSel.Count];

            int ida1 = 0;
            foreach (UnityMolAtom a in group)
            {
                allPointsg[ida1++] = loadedMol.InverseTransformPoint(a.curWorldPosition);
            }
            ida1 = 0;
            foreach (UnityMolAtom a in tmpSel)
            {
                //Transform points in the framework of the loadedMolecules transform
                queries[ida1++] = loadedMol.InverseTransformPoint(a.curWorldPosition);
            }

            GridSearchBurst gsb = new GridSearchBurst(2.289f);
            gsb.InitializeGrid(allPointsg).Complete();

            int[] resultsg = gsb.SearchWithin(queries, cutoff, maxRes);
        ...
        public HashSet<UnityMolAtom> applyold(HashSet<UnityMolAtom> group)
        {
            ...
            foreach (UnityMolAtom a in tmpSel)
            {
                int[] ids = tmpKDTree.FindNearestsRadius(
                    loadedMol.InverseTransformPoint(a.curWorldPosition),
                    cutoff
                );
        ...
        public AroundSelection(AroundSelection cpy)
            : base(cpy)
        {
            this.sel = cpy.sel.Clone();
        ...
        public override MetaClass Clone()
        {
            return new AroundSelection(this);
        }
    }
    ...
    public class InSphereSelection : DistanceSelection
    {
        ...
        public InSphereSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public override void init(List<string> tokens, ref int curId)
        {
            center.x = float.Parse(
                tokens[curId++],
                System.Globalization.CultureInfo.InvariantCulture
            );
            center.y = float.Parse(
                tokens[curId++],
                System.Globalization.CultureInfo.InvariantCulture
            );
            center.z = float.Parse(
                tokens[curId++],
                System.Globalization.CultureInfo.InvariantCulture
            );
            cutoff = float.Parse(
        ...
        public override HashSet<UnityMolAtom> apply(HashSet<UnityMolAtom> group)
        {
            ...
            int maxRes = group.Count;

            GridSearchBurst gsb = new GridSearchBurst(2.289f);
            gsb.InitializeGrid(allPoints).Complete();
            int[] results = gsb.SearchWithin(new Vector3[] { center }, cutoff, maxRes);
            gsb.Dispose();
        ...
        public InSphereSelection(InSphereSelection cpy)
            : base(cpy)
        {
            // this.sel = cpy.sel.Clone();
            this.cutoff = cpy.cutoff;
        ...
        public override MetaClass Clone()
        {
            return new InSphereSelection(this);
        }
    }

    public class InRectangleSelection : DistanceSelection
    {
        public Vector3 lowerLeft = Vector3.zero;
        public Vector3 xaxis = Vector3.zero;
        public Vector3 yaxis = Vector3.zero;
        public Vector3 zaxis = Vector3.zero;

        // public MetaClass sel;

        public InRectangleSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public override void init(List<string> tokens, ref int curId)
        {
            lowerLeft.x = float.Parse(
                tokens[curId++],
                System.Globalization.CultureInfo.InvariantCulture
            );
            lowerLeft.y = float.Parse(
                tokens[curId++],
                System.Globalization.CultureInfo.InvariantCulture
            );
            lowerLeft.z = float.Parse(
                tokens[curId++],
                System.Globalization.CultureInfo.InvariantCulture
            );
        ...
        public override HashSet<UnityMolAtom> apply(HashSet<UnityMolAtom> group)
        {
            ...
            bounds.Encapsulate(lowerLeft);
            bounds.Encapsulate(lowerLeft + xaxis);
            bounds.Encapsulate(lowerLeft + yaxis);
            bounds.Encapsulate(lowerLeft + zaxis);

            foreach (UnityMolAtom a in group)
            {
                Vector3 p = loadedMol.InverseTransformPoint(a.curWorldPosition);
        ...
        public InRectangleSelection(InRectangleSelection cpy)
            : base(cpy)
        {
            // this.sel = cpy.sel.Clone();
            this.lowerLeft = cpy.lowerLeft;
            this.xaxis = cpy.xaxis;
            this.yaxis = cpy.yaxis;
            this.zaxis = cpy.zaxis;
        }

        public override MetaClass Clone()
        {
            return new InRectangleSelection(this);
        }
    }
    ...
    public class ProteinSelection : MDASelection
    {
        ...
        public ProteinSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public ProteinSelection(ProteinSelection cpy)
            : base(cpy) { }
        ...
        public override HashSet<UnityMolAtom> apply(HashSet<UnityMolAtom> group)
        {
            ...
            foreach (UnityMolAtom a in group)
            {
                if (knownResidues.Contains(a.residue.name) && !a.isHET)
                {
                    result.Add(a);
                }
            }
        ...
        public override MetaClass Clone()
        {
            return new ProteinSelection(this);
        }
    }
    ...
    public class NucleicSelection : MDASelection
    {
        ...
        public NucleicSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public NucleicSelection(NucleicSelection cpy)
            : base(cpy) { }
        ...
        public override HashSet<UnityMolAtom> apply(HashSet<UnityMolAtom> group)
        {
            ...
            foreach (UnityMolAtom a in group)
            {
                if (knownNucleic.Contains(a.residue.name) && !a.isHET)
                {
                    result.Add(a);
                }
            }
        ...
        public override MetaClass Clone()
        {
            return new NucleicSelection(this);
        }
    }
    ...
    {
        //Based on recognized residue names
        public static HashSet<string> knownBases = new HashSet<string> { "N", "C", "CA", "O", };

        public BackboneSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public BackboneSelection(BackboneSelection cpy)
            : base(cpy) { }
        ...
        public override HashSet<UnityMolAtom> apply(HashSet<UnityMolAtom> group)
        {
            ...
            foreach (UnityMolAtom a in group)
            {
                ...
                if (
                    ProteinSelection.knownResidues.Contains(a.residue.name)
                    && knownBases.Contains(a.name)
                    && a.type != "CA"
                )
                {
                    result.Add(a);
        ...
        public override MetaClass Clone()
        {
            return new BackboneSelection(this);
        }
    }
    ...
    public class NucleicBackboneSelection : MDASelection
    {
        ...
        public NucleicBackboneSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public NucleicBackboneSelection(NucleicBackboneSelection cpy)
            : base(cpy) { }
        ...
        public override HashSet<UnityMolAtom> apply(HashSet<UnityMolAtom> group)
        {
            ...
            foreach (UnityMolAtom a in group)
            {
                ...
                if (
                    NucleicSelection.knownNucleic.Contains(a.residue.name)
                    && knownNucleicBBBases.Contains(a.name)
                )
                {
                    result.Add(a);
                }
        ...
        public override MetaClass Clone()
        {
            return new NucleicBackboneSelection(this);
        }
    }
    ...
    public class NucleicBaseSelection : MDASelection
    {
        ...
        public NucleicBaseSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public NucleicBaseSelection(NucleicBaseSelection cpy)
            : base(cpy) { }
        ...
        public override HashSet<UnityMolAtom> apply(HashSet<UnityMolAtom> group)
        {
            ...
            foreach (UnityMolAtom a in group)
            {
                ...
                if (
                    NucleicSelection.knownNucleic.Contains(a.residue.name)
                    && knownNucleicBases.Contains(a.name)
                )
                {
                    result.Add(a);
                }
        ...
        public override MetaClass Clone()
        {
            return new NucleicBaseSelection(this);
        }
    }
    ...
    public class NucleicSugarSelection : MDASelection
    {
        ...
        public NucleicSugarSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public NucleicSugarSelection(NucleicSugarSelection cpy)
            : base(cpy) { }
        ...
        public override HashSet<UnityMolAtom> apply(HashSet<UnityMolAtom> group)
        {
            ...
            foreach (UnityMolAtom a in group)
            {
                ...
                if (
                    NucleicSelection.knownNucleic.Contains(a.residue.name)
                    && knownNucleicSugarAtoms.Contains(a.name)
                )
                {
                    result.Add(a);
                }
        ...
        public override MetaClass Clone()
        {
            return new NucleicSugarSelection(this);
        }
    }
    ...
    public class WaterSelection : MDASelection
    {
        ...
        public WaterSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public WaterSelection(WaterSelection cpy)
            : base(cpy) { }
        ...
        public override MetaClass Clone()
        {
            return new WaterSelection(this);
        }
    }
    ...
    public class IonsSelection : MDASelection
    {
        ...
        public IonsSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public IonsSelection(IonsSelection cpy)
            : base(cpy) { }
        ...
        public override HashSet<UnityMolAtom> apply(HashSet<UnityMolAtom> group)
        {
            ...
            foreach (UnityMolAtom a in group)
            {
                ...
                else if (a.name.Length >= 2)
                {
                    ...
                    if (
                        ionNames.Contains(aname2)
                        || aname2 == a.residue.name
        ...
        public override MetaClass Clone()
        {
            return new IonsSelection(this);
        }
    }

    public class LigandSelection : MDASelection
    {
        public LigandSelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public LigandSelection(LigandSelection cpy)
            : base(cpy) { }
        ...
        public override MetaClass Clone()
        {
            return new LigandSelection(this);
        }
    }
    ...
    public class PropertySelection : MDASelection
    {
        ...
        //TODO implement this !
        public PropertySelection(MDAnalysisSelection mda, string t, int p)
            : base(mda, t, p) { }

        public PropertySelection(PropertySelection cpy)
            : base(cpy)
        {
        ...
        public override MetaClass Clone()
        {
            return new PropertySelection(this);
        }
        ...
        public static bool applyOp(string logic, float x, float y)
        {
            switch (logic)
            {
                ...
                default:
                    throw new System.Exception("Invalid logic");
            }
        }
    }
}
