...
Shader "UMol/Sticks HyperBalls Shadow Merged"
{
    ...
    SubShader {
        ...
        Tags { "DisableBatching" = "True" "RenderType" = "Opaque" "RenderPipeline" = "UniversalPipeline"}
        ...
        Pass {
            ...
            vertexOutput vert (appdata v) {
                ...
                //Calculate all the stuffs to create parallepipeds que defines the enveloppe for ray-casting
            ...
            fragmentOutput frag (vertexOutput i)
            {
                ...
                // basic lighting (URP-compatible, no shadow attenuation)
                ...
                // per pixel lighting
                half3 lighting = _LightColor0.rgb * ndotl * atten;
